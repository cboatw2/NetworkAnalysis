...
Dr. Collini's network visualziation shows the familial relationships of the people enslaved at various properties owned by George Washington. Because her full project is currently in re-design on her website I am relying on her code as well as conversations I have had with her and viewing the projects in the past. The network shows the the tension between agency and dependence that existed for enslaved families at Mount Vernon. Familial connections existed and persisted among Mount Vernon's enslaved population despite being physically separated by their enslavers. By adding locations as nodes in the graph it allows for a digital representation of the physical distance imposed by the system of enslavement on these families.

While the decision to represent people as nodes is sometimes debated in digital humanities, I think in this instance it is effective given the spatial underpinnings of the project. The database is built from the Mount Vernon Slavery Database. Normally, original research would be desireable for database creation, but since Dr. Collini worked at Mount Vernon, her deep knowledge of the sources behind this database certainly qualifies her to create a subset for her project.

Any time family and social networks for enslaved people are able to be created it pushes our understanding and southern history forward by increasing broadening the conception of their individual experiences within the system of slavery. Dr. Collini's network serves antebellum scholars well both in its argument and structure as well as an template for building network visualizations of other communities.
