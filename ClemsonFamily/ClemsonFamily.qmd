...
Other layers of connectedness could be explore, such as individual's involvement in religious, social and civic organizations.
...
Because the dataset is not as populated in regards to these organizations as compared to university departments, it is less reliable. However, based on known trends that exist even into the present day, more than likely the graph above would simply increase in size, but the 
